...
namespace Trend_Fashion_Strore.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductImageId,ImageName,ProductId,ImagePath,ProductColor")] ProductImage productImage)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "Categorize", productImage.ProductId);
            return View(productImage);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductImageId,ImageName,ProductId,ImagePath,ProductColor")] ProductImage productImage)
        {
